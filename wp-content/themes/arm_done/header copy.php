...
<body style="background-color: white">
	...
	// $menusAll = wp_get_nav_menu_items($menuGlobal[0]->term_id);
	// echo '<pre>';
	// var_dump($menuGlobal[0]->term_id);
	// echo '</pre>';
	// // exit();
	// $menus = array();

	// // Filtering items where the 'menu_item_parent' matches the specified parent ID
